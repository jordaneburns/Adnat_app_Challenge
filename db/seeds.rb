...
Organisation.create!(name: "Default", hourly_rate: 0)
...
Shift.create!(user_id: 1, start: DateTime::new(2022, 3, 20), finish: DateTime::new(2022, 3, 20), break_length: 30)
Shift.create!(user_id: 2, start: DateTime::new(2022, 3, 20), finish: DateTime::new(2022, 3, 20), break_length: 30)
Shift.create!(user_id: 3, start: DateTime::new(2022, 3, 20), finish: DateTime::new(2022, 3, 20), break_length: 30)
